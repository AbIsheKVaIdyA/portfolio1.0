    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      <div className="col-span-1 lg:col-span-2 h-full bg-gray-100 min-h-[500px] lg:min-h-[300px] rounded-2xl p-8">
        <h1 className="text-4xl lg:text-6xl font-medium">
          Hello! I am Abhishek Vaidya.
        </h1>
        <h1 className="text-4xl lg:text-3xl font-normal mt-3">
          Building Secure Systems as a Cybersecurity Graduate Student & Full Stack Developer | Future Red Teamer
        </h1>

        <a
          href="mailto:abhishekvaidya.work@gmail.com"
